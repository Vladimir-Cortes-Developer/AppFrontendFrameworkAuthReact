...
const API_BASE_URL = const API_BASE_URL = `${import.meta.env.VITE_API_BASE_URL || 'https://lab05webapiml20250927204256-huekfzc5dmc4e8ef.eastus2-01.azurewebsites.net'}/api`;;
